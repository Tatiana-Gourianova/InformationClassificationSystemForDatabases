...
<table class="table table-condensed table-bordered">
    ...
    <tr class="active">
        <td align="center" style="border-color: #dae5ff">${item.id}</td>
        <td align="center" style="border-color: #dae5ff">${item.name}</td>
        <td align="center" style="border-color: #dae5ff">${item.thickness}</td>
        <td align="center" style="border-color: #dae5ff">${item.density}</td>
        <td align="center" style="border-color: #dae5ff">${item.si63}</td>
        <td align="center" style="border-color: #dae5ff">${item.si125}</td>
        <td align="center" style="border-color: #dae5ff">${item.si250}</td>
        <td align="center" style="border-color: #dae5ff">${item.si500}</td>
        <td align="center" style="border-color: #dae5ff">${item.si1000}</td>
        <td align="center" style="border-color: #dae5ff">${item.si2000}</td>
        <td align="center" style="border-color: #dae5ff">${item.si4000}</td>
        <td align="center" style="border-color: #dae5ff">${item.si8000}</td>
    </tr>
